...
import type { MenuProfileSummary, MenuSnapshot } from './model.js';

export function createMenuSnapshot(context: DeviceContext): MenuSnapshot {
...
function menuProfiles(repositoryPath: string): MenuProfileSummary[] {
