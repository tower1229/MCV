...
export type InspectInventoryInput = z.infer<typeof InspectInventoryInputSchema>;
export type InspectInventoryOutput = z.infer<typeof InspectInventoryOutputSchema>;
export type ReadAssetsInput = z.infer<typeof ReadAssetsInputSchema>;
export type ReadAssetsOutput = z.infer<typeof ReadAssetsOutputSchema>;
export type AssetContent = z.infer<typeof AssetContentSchema>;
export type UpdateProfilesInput = z.infer<typeof UpdateProfilesInputSchema>;
export type UpdateProfilesOutput = z.infer<typeof UpdateProfilesOutputSchema>;
export type DeployProfilesInput = z.infer<typeof DeployProfilesInputSchema>;
export type DeployProfilesOutput = z.infer<typeof DeployProfilesOutputSchema>;
