...
export class GeminiNativeFileHandler {
    ...
    async capture(files, context) {
        const result = { files: [], managedFiles: [], managedFields: [], summary: { fileCount: 0, parameterizedPathCount: 0, excludedFileCount: 0 }, warnings: [] };
...
export function projectGeminiNativeAsset(fileId, content, context) {
    const targetByFileId = {
...
function antigravityUserDirectory(context) {
