...
const EMPTY_PENDING = { total: 0, add: 0, modify: 0, delete: 0 };
const EMPTY_DRIFT = { file: 0, content: 0, topology: 0, missing: 0 };
export async function createMenuSnapshot(context) {
    ...
    try {
        ...
        const fileDrift = Math.max(0, status.postDeployLocalState.drift
...
async function detectedIdeCount(context) {
    try {
