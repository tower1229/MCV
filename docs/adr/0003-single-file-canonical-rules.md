...
- **Multiple rule files (`common/rules/coding.md`, `architecture.md`, etc.)** — better granularity, but adds concatenation order logic, separator handling, and per-file metadata without a validated user benefit.
