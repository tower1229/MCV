...
Use this checklist for `0.2.0-beta.1`. Publishing and tagging are maintainer-confirmed actions; repository changes alone do not publish a package.

## Release candidate

- [ ] `package.json` and `package-lock.json` use `0.2.0-beta.1`.
- [ ] `CHANGELOG.md` describes user-visible changes, security updates, and migration requirements.
- [ ] README, PRD, ADRs, and maintainer instructions agree on the current product contract.
